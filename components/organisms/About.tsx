...
const About: FC = () => {
    return (
        <div className="h-screen relative flex flex-col items-center bg-primary-light ">
            ...
            <div className="h-full mx-auto tablet:w-2/3 flex flex-col tablet:flex-row items-center justify-center gap-md tablet:gap-lg">
                <div className="w-[200px] text-right  tablet:w-auto tablet:flex-1">
                    <div className="inline-block ml-auto  border-dashed border-primary-lighter border-2  p-2">
                        <Image
                            src={aboutImg}
                            width={400}
                            className="ml-auto border-[10px]  border-white shadow"
                ...
                <div className="px-lg tablet:px-0 tablet:flex-1 flex flex-col gap-sm text-center tablet:text-left ">
                    ...
                    <p className="px-md tablet:px-0 text-lg max-w-[340px]">
                        Welkom op mijn persoonlijke travel blog{' '}
                        <b>The Active Sloth!</b>
                    </p>
                    <p className="px-md mb-sm tablet:px-0 text-lg max-w-[360px]">
