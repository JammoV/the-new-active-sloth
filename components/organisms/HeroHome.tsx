...
const HeroHome: FC = async () => {
    ...
    return (
        <div
            className={`h-[calc(100vh-54px)] desktop:h-[calc(100vh-72px)] desktop:px-sm pb-sm  bg-white`}
        >
            <HeroWrapper image={featuredImage}>
                <div className="flex flex-col items-center justify-center h-full gap-lg desktop:gap-sm">
                    <div className="flex flex-col desktop:flex-row items-center desktop:gap-xs">
                        <span className="font-fira leading-10 desktop:leading-normal text-4xl">
                            Reis
                        </span>
                        <span className="font-caveat leading-10  desktop:leading-normal text-4xl">
                            Relax
                        </span>
                        <span className="font-fira leading-10  desktop:leading-normal text-4xl">
                            Repeat
